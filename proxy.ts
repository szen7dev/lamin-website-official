...
const redirects = new Map([
  ...
  ['/cooperate', '/doi-tac'],
  ['/testing-result', '/ket-qua-kiem-nghiem'],
  ['/branding-story', '/cau-chuyen-thuong-hieu']
]);
...
const rewrites = new Map([
  ...
  ['/doi-tac', '/cooperate'],
  ['/ket-qua-kiem-nghiem', '/testing-result'],
  ['/cau-chuyen-thuong-hieu', '/branding-story']
]);
...
export async function proxy(request: NextRequest) {
  ...
  // Prevent third-party cookie issues
