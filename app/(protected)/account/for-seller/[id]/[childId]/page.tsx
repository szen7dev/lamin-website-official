...
import CreateHeightMeasurementModal from '@/components/modal/CreateHeightMeasurementModal';
...
export default function HeightMeasureHistoryPage() {
  ...
  const {
    ...
    contactID: Array.isArray(params.childId)
      ? params.childId[0]
      : params.childId,
    limit: 100,
  });
  ...
  return (
    <div>
      ...
      <CreateHeightMeasurementModal
        contactId={
          Array.isArray(params.childId) ? params.childId[0] : params.childId
        }
        isOpen={isModalOpen}
