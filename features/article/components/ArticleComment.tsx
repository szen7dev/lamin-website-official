    ...
    <div className="space-y-6">
      {isSubmitted ? (
        <div className="rounded-lg bg-success-5/10 p-6 text-center">
          ...
          <h3 className="mb-2 text-lg font-semibold text-grayscale-90">
            Đã kiểm duyệt nội dung
          </h3>
          <p className="text-grayscale-60">
            Cảm ơn bạn đã để lại bình luận. Bình luận của bạn sẽ được hiển thị
        ...
        <form
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              <label
                className="mb-1 block text-sm text-grayscale-70"
                htmlFor="name">
