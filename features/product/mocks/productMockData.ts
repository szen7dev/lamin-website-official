...
export const mockReviews: ProductReview[] = [
  ...
  },
  {
    ...
    rating: 5,
    content:
      'Mình dùng sản phẩm này cho bé nhà mình, thấy bé ăn ngon miệng hơn và ít bị táo bón',
    author: {
      name: 'Thu Thảo',
    },
...
export const mockQuestions: ProductQuestion[] = [
  {
    ...
    answer:
      'Sản phẩm có thể dùng cho trẻ em từ 6 tuổi trở lên, liều dùng 1 ống/ngày.',
    author: {
      name: 'Minh Anh',
    },
  ...
  },
  {
    ...
    answer:
      'Bạn có thể uống vào bất kỳ thời điểm nào trong ngày, tốt nhất là uống trước hoặc trong bữa ăn.',
    author: {
      name: 'Thanh Thảo',
    },
...
export const mockRelatedProducts: Product[] = [
  {
    ...
    shortDescription:
      'Men vi sinh Enterogermina 5ml hỗ trợ tiêu hóa, phòng ngừa rối loạn tiêu hóa',
    description:
      'Men vi sinh Enterogermina 5ml giúp cân bằng hệ vi sinh đường ruột, hỗ trợ tiêu hóa tốt',
    images: [
      {
        id: '1',
    ...
    ingredients: 'Bacillus clausii',
    ingredientsDescription:
      'Chứa bào tử vi khuẩn Bacillus clausii có lợi cho đường ruột',
  ...
  },
  {
    ...
    shortDescription:
      'Enterogermina Plus bổ sung lợi khuẩn, tăng cường hệ miễn dịch đường ruột',
    description:
      'Enterogermina Plus với công thức cải tiến, bổ sung nhiều chủng lợi khuẩn hơn',
    images: [
      {
        id: '1',
        url: 'https://v0.dev/placeholder.svg?height=200&width=200',
    ...
    ingredientsDescription:
      'Kết hợp nhiều chủng lợi khuẩn giúp cân bằng hệ vi sinh đường ruột',
  ...
  },
  {
    ...
    shortDescription:
      'Enterogermina Kids dành riêng cho trẻ em, hương vị dễ uống',
    description:
      'Enterogermina Kids với công thức đặc biệt phù hợp cho trẻ em từ 3 tuổi trở lên',
    images: [
      {
        id: '1',
        url: 'https://v0.dev/placeholder.svg?height=200&width=200',
    ...
    ingredientsDescription:
      'Kết hợp men vi sinh và vitamin D giúp tăng cường miễn dịch cho trẻ',
