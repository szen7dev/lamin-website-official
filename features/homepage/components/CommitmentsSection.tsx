...
export default function CommitmentsSection() {
  return (
    <section
      ...
      className="rounded-lg bg-primary-5/5 py-8">
      <div className="container mx-auto px-4">
        <h2
          className="mb-8 text-center text-2xl font-bold text-primary-5"
        ...
        <ul className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {commitments.map(commitment => (
            <li
              ...
              <commitment.icon
                aria-hidden="true"
                className="mb-4 h-12 w-12 text-primary-40"
              />
              <h3 className="mb-2 font-semibold text-grayscale-90">
                {commitment.title}
              </h3>
