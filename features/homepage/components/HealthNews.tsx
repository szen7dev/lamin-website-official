    ...
    <section aria-labelledby="health-news-title">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 id="health-news-title" className="text-lg font-semibold text-grayscale-90">
            Góc Sức Khỏe
          </h2>
        </div>
        <Link href="/health-news" className="flex items-center gap-1 text-primary-40 text-sm hover:underline">
          Xem thêm
      ...
      {/* Categories */}
      <nav className="mb-6 flex flex-wrap gap-2" aria-label="Danh mục sức khỏe">
            ...
            <article key={article.id} className="group">
              <Link href={article.href} className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <time dateTime={article.date} className="mt-1 text-xs text-grayscale-50">
                    {article.date}
                  </time>
                </div>
              </Link>
