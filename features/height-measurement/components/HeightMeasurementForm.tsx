...
export default function HeightMeasurementForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      {/* Phone */}
      <div className="space-y-2">
        <label htmlFor="phone" className="flex items-center text-sm text-grayscale-90">
          <span className="text-error-5 mr-1">*</span>
        ...
        />
        {errors.phone && <p className="text-sm text-error-5">{errors.phone.message}</p>}
      </div>
      ...
      <div className="space-y-2">
        ...
        {errors.gender && <p className="text-sm text-error-5">{errors.gender.message}</p>}
      </div>
